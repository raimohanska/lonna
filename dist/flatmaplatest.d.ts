...
export declare function flatMapLatest<A, B>(s: EventStream<A> | EventStreamSeed<A>, fn: Spawner<A, EventStreamSeed<B>>): EventStreamSeed<B>;
export declare function flatMapLatest<A, B>(s: EventStream<A> | EventStreamSeed<A>, fn: Spawner<A, EventStreamSeed<B>>, scope: Scope): EventStream<B>;
