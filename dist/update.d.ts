...
export declare type UpdateTrigger<T> = EventStream<T> | EventStreamSeed<T>;
export declare type UpdateParam<T> = UpdateTrigger<T> | Property<T>;
/**
 *  [Update](#update) pattern consisting of a single EventStream and a accumulator function.
 */
export declare type UpdatePattern1<I1, O> = [UpdateTrigger<I1>, O | ((acc: O, a: I1) => O)];
/**
 *  [Update](#update) pattern consisting of 2 Observables and an accumulrator function.
 */
export declare type UpdatePattern2<I1, I2, O> = [UpdateTrigger<I1>, Property<I1>, O | ((acc: O, a: I1, b: I2) => O)];
/**
 *  [Update](#update) pattern consisting of 3 Observables and an accumulrator function.
 */
export declare type UpdatePattern3<I1, I2, I3, O> = [UpdateTrigger<I1>, Property<I1>, Property<I3>, O | ((acc: O, a: I1, b: I2, c: I3) => O)];
/**
 *  [Update](#update) pattern consisting of 4 Observables and an accumulrator function.
 */
export declare type UpdatePattern4<I1, I2, I3, I4, O> = [UpdateTrigger<I1>, Property<I1>, Property<I3>, Property<I4>, O | ((acc: O, a: I1, b: I2, c: I3, d: I4) => O)];
/**
 *  [Update](#update) pattern consisting of 5 Observables and an accumulrator function.
 */
export declare type UpdatePattern5<I1, I2, I3, I4, I5, O> = [UpdateTrigger<I1>, Property<I1>, Property<I3>, Property<I4>, Property<I5>, O | ((acc: O, a: I1, b: I2, c: I3, d: I4, e: I5) => O)];
/**
 *  [Update](#update) pattern consisting of 6 Observables and an accumulrator function.
 */
export declare type UpdatePattern6<I1, I2, I3, I4, I5, I6, O> = [UpdateTrigger<I1>, Property<I1>, Property<I3>, Property<I4>, Property<I5>, Property<I6>, O | ((acc: O, a: I1, b: I2, c: I3, d: I4, e: I5, f: I6) => O)];
/**
 ...
 */
export declare function update<Out>(initial: Out, ...patterns: UpdatePattern<Out>[]): PropertySeed<Out>;
export declare function update<Out>(scope: Scope, initial: Out, ...patterns: UpdatePattern<Out>[]): Property<Out>;
