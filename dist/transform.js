...
function transform(desc, x, transformer, scope) {
    if (x instanceof abstractions_1.EventStream || x instanceof abstractions_1.EventStreamSeed) {
        if (transformer instanceof Function) {
            ...
            return applyscope_1.applyScopeMaybe(new abstractions_1.EventStreamSeed(desc, function (observer) { return source_1.subscribe(function (value) { return transformer(value, observer); }); }));
        }
        else {
