...
export declare function flatMap<A, B>(s: EventStream<A> | EventStreamSeed<A>, fn: Spawner<A, EventStreamSeed<B>>): EventStreamSeed<B>;
export declare function flatMap<A, B>(s: EventStream<A> | EventStreamSeed<A>, fn: Spawner<A, EventStreamSeed<B>>, scope: Scope): EventStream<B>;
