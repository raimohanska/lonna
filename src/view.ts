...
export function view<V, V2, R>(a: Property<V>, fn1: Function1<V, V2>, fn2: Function1<V2, R>): Property<R>
export function view<V, V2, V3, R>(a: Property<V>, fn1: Function1<V, V2>, fn2: Function1<V2, V3>, fn3: Function1<V3, R>): Property<R>
...
export function view<A, B>(a: PropertySeed<A>, lens: LensLike<A, B>): PropertySeed<B>;
export function view<V, R>(a: PropertySeed<V>, fn: Function1<V, R>): PropertySeed<R>
export function view<V, V2, R>(a: PropertySeed<V>, fn1: Function1<V, V2>, fn2: Function1<V2, R>): PropertySeed<R>
export function view<V, V2, V3, R>(a: PropertySeed<V>, fn1: Function1<V, V2>, fn2: Function1<V2, V3>, fn3: Function1<V3, R>): PropertySeed<R>
...
export function view<A, B>(a: EventStream<A>, lens: LensLike<A, B>): EventStream<B>;
export function view<V, R>(a: EventStream<V>, fn: Function1<V, R>): EventStream<R>
export function view<V, V2, R>(a: EventStream<V>, fn1: Function1<V, V2>, fn2: Function1<V2, R>): EventStream<R>
export function view<V, V2, V3, R>(a: EventStream<V>, fn1: Function1<V, V2>, fn2: Function1<V2, V3>, fn3: Function1<V3, R>): EventStream<R>
...
export function view<A, B>(a: EventStreamSeed<A>, lens: LensLike<A, B>): EventStreamSeed<B>;
