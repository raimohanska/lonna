...
export interface ObservableSeed<V, C extends Observable<unknown>, O extends ScopedObservable<unknown>> extends Pipeable, ObservableIdentifiers, ForEach<V> {
...
export type PropertySource<V> = Observable<V> & PropertySeed<V> & PropertyMethods<V> & HKT<PropertySource<V>> & {
    observableType(): "PropertySource" | "Property" | "AtomSource" | "Atom"    
}
export type Property<V> = ScopedObservable<V> & PropertySource<V> & PropertyMethods<V> & HKT<Property<V>> & {
    observableType(): "Property" | "Atom"    
}

export type PropertySeed<V> = ObservableSeed<V, PropertySource<V>, Property<V>> & HKT<PropertySeed<V>> & {
    observableType(): "PropertySeed" | "PropertySource" | "Property" | "AtomSeed" | "AtomSource" | "Atom"
}

export type EventStreamSource<V> = Observable<V> & EventStreamSeed<V> & HKT<EventStreamSource<V>> & {
    observableType(): "EventStreamSource" | "EventStream" | "Bus"
}
export type EventStream<V> = ScopedObservable<V> & EventStreamSource<V> & HKT<EventStream<V>> & {
    observableType(): "EventStream" | "Bus"
}
export type EventStreamSeed<V> = ObservableSeed<V, EventStreamSource<V>, EventStream<V>> & HKT<EventStreamSeed<V>> & {
    observableType(): "EventStreamSeed" | "EventStreamSource" | "EventStream" | "Bus"       
}


export type AtomSource<V> = PropertySource<V> & PropertySeed<V> & AtomSeed<V> & HKT<AtomSource<V>> & {
    observableType(): "AtomSource" | "Atom"
    set(updatedValue: V): void;
}
export type AtomSeed<V> = ObservableSeed<V, AtomSource<V>, Atom<V>> & HKT<AtomSeed<V>> & {
    observableType(): "AtomSeed" | "AtomSource" | "Atom"
}

export type Atom<V> = Property<V> & AtomSource<V> & HKT<Atom<V>> & {
    observableType(): "Atom"
    set(newValue: V): void
