  ...
  describe("Updates value based on stream events", () =>
    expectPropertyEvents(
      function () {
        ...
        return update(0, [a, (acc, x) => acc + x], [b, (acc, x) => acc + x])
      },
      [0, "0x", "0xy"]
    ))
  ...
  describe("Supports constant result value", () =>
    expectPropertyEvents(
      function () {
        ...
        return update(0, [a, (acc, x) => acc + x], [b, 666])
      },
      [0, "0x", 666]
    ))
  ...
  describe("Scoped version", () =>
    expectPropertyEvents(
      function () {
        ...
        return update(testScope(), 0, [a, (acc, x) => acc + x], [b, 666])
      },
      [0, "0x", 666]
    ))

  it("toString", () => {
    expect(update(0, [never(), (state, v) => state]).toString()).toEqual(
      "PropertySeed update(0,[[never,fn]])"
    )
  })
})
