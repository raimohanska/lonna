...
export function changes<O extends PropertySeed<any> | Property<any>>(property: O): O extends Property<infer A> ? EventStream<A> : O extends PropertySeed<infer A> ? EventStreamSeed<A>: never;
